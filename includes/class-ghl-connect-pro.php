...
class GHLCONNECTPRO {
	...
	private function define_admin_hooks() {
        ...
        $this->loader->add_filter('plugins_api', $updater, 'gfghlpro_info', 20, 3);
        $this->loader->add_filter('site_transient_update_plugins', $updater,'gfghlpro_update');
        $this->loader->add_action('upgrader_process_complete', $updater, 'gfghlpro_purge', 10, 2);
		$this->loader-> add_action('in_plugin_update_message-' . GHLCONNECTPRO_PATH, $updater, 'gfghlpro_update_message', 10, 2);
